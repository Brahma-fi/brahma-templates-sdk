export const ExecutorPluginABI = [
  {
    inputs: [
  ...
  { inputs: [], name: "InvalidAddressProvider", type: "error" },
  { inputs: [], name: "InvalidExecutor", type: "error" },
  { inputs: [], name: "InvalidSignature", type: "error" },
  { inputs: [], name: "ModuleExecutionFailed", type: "error" },
  {
    inputs: [{ internalType: "address", name: "", type: "address" }],
    name: "NotGovernance",
    type: "error"
  },
  { inputs: [], name: "UnableToParseOperation", type: "error" },
  {
    inputs: [],
